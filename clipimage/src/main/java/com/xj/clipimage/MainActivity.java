...
import com.xj.clipimage.util.ActivityResultHelper;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void gotoCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(this, getApplicationContext().getPackageName() + ".provider", tempFile);
...
//                Log.i(TAG, "result Code="+resultCode+", Data" + data.getData());
//            }
//        });
    }
