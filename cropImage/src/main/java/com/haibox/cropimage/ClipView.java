...
public class ClipView extends View {
     ...
     * 裁剪框类别，圆形、矩形
     */
    public final static class ClipType {
        public static final int CIRCLE = 1;
        public static final int RECTANGLE = 2;
        public static final int PALACE = 3;
    }
    ...
    //裁剪框类别，（圆形、矩形），默认为圆形
    private int clipType = ClipType.CIRCLE;
...
//            canvas.drawCircle(100, 100, clipRadiusWidth, paint);
            //白色的圆边框
            canvas.drawCircle(this.getWidth() / 2f, this.getHeight() / 2f, clipRadiusWidth, borderPaint);
//            canvas.drawCircle(100, 100, clipRadiusWidth, borderPaint);
        } else if (clipType == ClipType.RECTANGLE) { //绘制矩形裁剪框
            //绘制中间白色的矩形蒙层
            canvas.drawRect(mHorizontalPadding, this.getHeight() / 2f - clipWidth / 2f,
                    this.getWidth() - mHorizontalPadding, this.getHeight() / 2f + clipWidth / 2f, paint);
            //绘制白色的矩形边框
            canvas.drawRect(mHorizontalPadding, this.getHeight() / 2f - clipWidth / 2f,
                    this.getWidth() - mHorizontalPadding, this.getHeight() / 2f + clipWidth / 2f, borderPaint);
...
//        switch (type) {
//            case TYPE_ROUND:
//                this.setClipType(ClipType.CIRCLE);
//                break;
//            case TYPE_RECT:
//                this.setClipType(ClipType.RECTANGLE);
//                break;
//            case TYPE_PALACE:
//                this.setClipType(ClipType.PALACE);
//                break;
//            default:
//                this.setClipType(ClipType.PALACE);
//                break;
...
//    }
     ...
     * @param clipType
     */
    public void setClipType(@IntRange(from = ClipType.CIRCLE, to = ClipType.PALACE) int clipType) {
