...
import com.haibox.cropimage.util.BitmapUtil;
...
/**
 * 博客地址：<a href="https://blog.csdn.net/gdutxiaoxu/article/details/89576088">...</a>
 *
 * @author xujun
 * @time 19-4-26
 */
public class ClipViewLayout extends RelativeLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        Log.i(TAG, "mWidthPixels=" + mWidthPixels+", mHorizontalPadding=" + mHorizontalPadding + ", mPreViewW=" + mPreViewW);
    }
